...
SERVICE="archiver"
BASE_PATH="$BASE_PATH_PREFIX/$SERVICE/values/demo"
...
$BOILERPLATE_PATH/$BOILERPLATE_BINARY --var-file build_vars.yml --template-url ./$BASE_PATH/alpha-template --output-folder $BASE_PATH/$TARGET_PROJECT --non-interactive
